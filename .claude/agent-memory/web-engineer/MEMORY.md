...
- [The card frame trips a card-rooted scan](the-card-frame-trips-a-card-rooted-scan.md) — EV-259 stop: Card box-shadow (paint) + CardHead icon <path> (geometry) red on shipped; text limb clean
