 ...
 * keep the Swap sheet as it was, with no recipe search (EV-272 AC1; the separate
 * "Use one of my recipes" button no longer exists, R1). No browser, no server.
 */
test("only a literal true opens the Swap sheet on recipes; absent, null and malformed values keep the old sheet", () => {
